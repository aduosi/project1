    ...
    <form action="/HandleLogin" method="post">
        ...
        <div class="form-inline">
         ...
         <!--     <table id="RadioButtonList1" border="0">
                    <tbody><tr>
                        <td><input id="RadioButtonList1_0" type="radio" name="RadioButtonList1" value="管理员" tabindex="4">
                            <label for="RadioButtonList1_0">管理员</label>
                        </td><td><input id="RadioButtonList1_1" type="radio" name="RadioButtonList1" value="会员" tabindex="4">
                        <label for="RadioButtonList1_1">会员</label></td>
                    </tr>
                    </tbody></table> -->
